...
const initialParts = [
  { id: '1', materialNo: 'SP-001-A', name: '导柱 D25×300', life: '300,000', fragile: true },
  { id: '2', materialNo: 'SP-002-B', name: '导套 D25×80', life: '300,000', fragile: true },
  { id: '3', materialNo: 'SP-005-C', name: '顶针 φ3×150', life: '200,000', fragile: true },
  { id: '4', materialNo: 'SP-012-A', name: '滑块座', life: '500,000', fragile: false },
  { id: '5', materialNo: 'SP-015-B', name: '弹簧 φ12×50', life: '150,000', fragile: true },
  { id: '6', materialNo: 'SP-020-C', name: '定位销 φ8×30', life: '250,000', fragile: false },
  { id: '7', materialNo: 'SP-025-A', name: '密封圈 O形圈', life: '100,000', fragile: true },
  { id: '8', materialNo: 'SP-030-B', name: '冷却水管接头', life: '400,000', fragile: false },
  { id: '9', materialNo: 'SP-035-C', name: '限位块', life: '600,000', fragile: false },
  { id: '10', materialNo: 'SP-040-A', name: '耐磨板', life: '450,000', fragile: true },
  { id: '11', materialNo: 'SP-045-B', name: '锁紧螺母', life: '350,000', fragile: false },
  { id: '12', materialNo: 'SP-050-C', name: '导向键', life: '550,000', fragile: false },
]
    ...
    <MainLayout>
      <div className="h-full flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-3 shrink-0">
          <div className="flex items-center gap-2">
            <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">所属模具: PA66外壳模具</span>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200">
            ...
            <div className="px-4 py-3 border-t border-gray-100 flex items-center justify-between">
              <span className="text-xs text-gray-500">
                共 {filteredParts.length} 条，显示 {(currentPage - 1) * pageSize + 1}-{Math.min(currentPage * pageSize, filteredParts.length)} 条
              </span>
              <div className="flex items-center gap-1">
                <button
